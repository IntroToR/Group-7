...
write.table(ratingbycountry, file = "https://github.com/IntroToR/Group-7/tree/master/data/Overall_Rating_by_Country.txt")
ratingbycountry
```
...
countryrating.plot <- ggplot(coffee_ratings) +
  ...
  ylim(55L, 95L)
ggsave("https://github.com/IntroToR/Group-7/tree/master/Figures/ratingbycoutry.png",  width = 12, height = 5)
countryrating.plot
```
...
write.table(world_coffee_rating, file = "https://github.com/IntroToR/Group-7/tree/master/data/mapping_coffee_rating.txt")
world_coffee_rating
```
...
ggsave("https://github.com/IntroToR/Group-7/tree/master/Figures/map_coffee_ratings.png",  width = 12, height = 5)
coffee_rating_map
```
