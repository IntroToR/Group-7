...
```
  ...
  Some of these variables can be too technical for the readers who are not familiar to this area. Therefore, before moving to the next sections, it would  be better to learn a little about their meanings. The detailed descriptions for each variables can be found in Table 1.
